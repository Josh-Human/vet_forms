...
import { ROUTE_PATH as VET_PATH } from '#app/routes/onboarding+/vet'
import { ROUTE_PATH as PRACTICE_PATH } from '#app/routes/onboarding+/practice'
...
export function Header() {
  ...
  const headerTitle = () => {
    ...
    if (location.pathname === VET_PATH) return 'Vet'
    if (location.pathname === PRACTICE_PATH) return 'Practice'
  }
  const headerDescription = () => {
    ...
    if (location.pathname === VET_PATH) return 'Your veterinarian details.'
    if (location.pathname === PRACTICE_PATH) return 'Your primary practice details.'
  }
